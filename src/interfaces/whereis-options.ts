...
/**
 * WhereisOptions defines the supported options for the git-annex whereis command.
 * @category Command Options
 */
export interface WhereisOptions extends AnnexOptions {

  /**
   * Shows whereis information for all known keys.
   */
  '--all'?: null;
  ...
  /**
   * Shows where a particular git-annex key is located.
   */
  '--key'?: string;

  /**
   * Shows whereis information for files found by last run of git-annex unused.
   */
  '--unused'?: null;
